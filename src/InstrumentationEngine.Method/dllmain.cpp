...
class CCrossPlatClassFactory : public IClassFactory, public CommonLib::CModuleRefCount
{
private:
...
public:
    ...
    STDMETHOD(STDMETHODCALLTYPE) QueryInterface(REFIID riid, PVOID* ppvObject) override
    {
        ...
        hr = CommonLib::ImplQueryInterface(
...
public:
        ...
        ) override
    {
        ...
        CComPtr<CInstrumentationMethodBase> pInstrumentationMethod;
        pInstrumentationMethod.Attach(new CInstrumentationMethodBase);
